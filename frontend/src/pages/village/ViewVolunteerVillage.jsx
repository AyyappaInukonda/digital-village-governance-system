// File Path: src/pages/village/ViewVolunteerVillage.jsx
...
// sessionstorage village
  const village=JSON.parse(sessionStorage.getItem('village'));
  

  // get volunteers of current village
  // const [villageVolunteers, setVillageVolunteers] = useState([]);

  const getVolunteers=async()=>{
    try{
      const response = await AxiosApi.get(`volunteer/get/${village.id}`);
...
export default ViewVolunteerVillage;
