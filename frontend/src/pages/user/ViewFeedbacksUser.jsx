...
const ViewFeedbacksUser = () => {
  ...
  const fetchFeedbacks = async () => {
    try {
      const response = await AxiosApi.get(`feedback/get/${user.id}`);
              ...
              {feedbacks&&feedbacks.map((item,index) => (
                <tr>
                 ...
                 className=""
                  ...
                  <td className="p-4 border-b border-blue-gray-50">{item.village.name}</td>
...
export default ViewFeedbacksUser;
