...
const volunteer=JSON.parse(sessionStorage.getItem('volunteer'))
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(profile);
    try {
      const res = await AxiosApi.put(`user/${volunteer.id}`, formData);
      console.log(res);
      setData({
        userName: "",
        email: "",
      ...
      toast.success(res.data.msg);
       navigation("/volunteer/view-users");
    } catch (error) {
      console.log(error);
    ...
    <div>
      <section className=" min-h-screen flex box-border justify-center items-center">
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-green-100 rounded-2xl flex max-w-3xl p-5 items-center">
            <div className="md:w-1/2 px-8">
              <h2 className="font-bold text-3xl text-[#002D74]">Add User </h2>
              ...
              <div className="mt-6  items-center text-gray-100"></div>
            </div>
